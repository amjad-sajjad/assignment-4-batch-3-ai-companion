...
const Image = () => {
    const { images, setSingleImage } = useContext(ImageContext);
    console.log(images)
        ...
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
                {/* <!-- Image Card 1 --> */}
                {
                    ...
                    (
                        <div key={image.id} className="image-card rounded-xl overflow-hidden  relative" onClick={() => {
                            ...
                            {image.isLoading ? <div className="w-full h-48 object-cover flex items-center justify-center flex-col"><span className="loading loading-bars loading-xl"></span>
                                ...
                                <img src={image.imageUrl} alt="Anime character in kimono"
